...
<header class="header">
  <div class="header__title-wrap--back header-border">
    <a href="javascript:;" class="header__btn-back">Back</a><h1 class="header__title">Member Registration 2/4</h1>
  </div>
</header>
            ...
            <div class="wrap__content--tb">
                <div class="content">
                    <div class="join">
                        <form id="inputPwdForm" name="inputPwdForm" action="join_step3.php" method="post">
                            <input type="hidden" name="step2_email" value="<?php echo $_POST['step1_email'] ?>" >
