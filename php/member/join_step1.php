...
<header class="header">
        ...
        <div class="join">
          <div class="join-input">            
            <div class="join-input__row">
              ...
              <form id="inputEmailForm" name="inputEmailForm" action="join_step2.php" method="post">
                <div class="text-input__wrapper">
                  <input type="email" name="step1_email" class="join-input email clearInput" placeholder="이메일을 입력하세요.">
  ...
  <script>
    ...
    function onNextStep() {
      ...
      //console.log(email);
      document.inputEmailForm.submit();
    }
